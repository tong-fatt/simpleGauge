  ...
  function Needle( site) {
    ...
    */
	...
	for (i = 0 ; i< 3; i++){
        ...
        needle[worksheetData._data[i][0]._value] = new Needle( worksheetData._data[i][1]._value);

        console.log("needle obj:" + JSON.stringify(  needle[worksheetData._data[i][0]._value]))
		needle[worksheetData._data[i][0]._value].moveTo( worksheetData._data[i][1]._value, 0.3, 1,
